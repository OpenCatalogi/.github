...
> OpenCatalogi scant GitHub elke nacht, als je een component sneller wilt aanmelden of bijwerken, kan dat via [opencatalogi.nl](https://opencatalogi.nl/documentation/about) gaan en onder "documentatie->over" (hoofd menu). Deze trigger wordt ook afgevuurd door de workflow.
