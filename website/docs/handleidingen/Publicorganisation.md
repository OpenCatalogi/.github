...
|Naam|Repository URl                |
|---|--------------------------|
| OpenCatalogi| [https://github.com/open-zaak/open-zaak](https://github.com/open-zaak/open-zaak)  |
| OpenZaak | [https://github.com/open-zaak/open-zaak](https://github.com/open-zaak/open-zaak)  |
...
3. Plak in de balk "Meld uw component" je URL van jouw .github repository e.g. "[https://github.com/[organisatienaam]/.github](https://github.com/[organisatienaam]/.github)"
...
6. In het veld "Payload URL" voer je de URL in waar je de webhook-gebeurtenissen naartoe wilt sturen. In jouw geval zou dit [https://api.opencatalogi.nl/github_events](https://api.opencatalogi.nl/github_events) zijn.
...
1. Ga naar de pagina van jouw nieuwe groep. Dit zou iets moeten zijn als [https://gitlab.com/[groepsnaam]](https://gitlab.com/[groepsnaam]).
...
3. Plak in de balk "Meld uw component" jouw URL van jouw `.gitlab`-project e.g. "[https://gitlab.com/[groepsnaam]/.gitlab](https://gitlab.com/[groepsnaam]/.gitlab)"
